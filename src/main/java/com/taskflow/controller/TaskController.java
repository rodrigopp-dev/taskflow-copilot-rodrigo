...
public class TaskController {
    ...
    @Operation(summary = "Lista tareas vencidas",
            description = "Lista todas las tareas vencidas (dueDate pasado y no DONE) ordenadas por fecha ascendente.")
    ...
    /** GET /tasks/unassigned — lista las tareas sin responsable de todos los proyectos. */
    @Operation(summary = "Lista tareas sin responsable",
            description = "Lista todas las tareas sin responsable ordenadas por dueDate ascendente.")
